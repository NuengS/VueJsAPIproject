      ...
      try
      {
        if (error) {
          ...
          if (correct)
          {
            ...
            return res.status(201).json({ error: false, message: 'user sigin', userId: userId, accessToken: token })
          }else {
...
app.get(apiversion + "/customers", function (req, res) {
    db.query("SELECT * FROM users WHERE status_id =1 ", function (error, results, fields) {
      if (error) throw error
  ...
  app.get(apiversion + "/hairdressers", function (req, res) {
    ...
    db.query("SELECT * FROM users WHERE status_id =2 ", function (error, results, fields) {
      if (error) throw error
      return res.json({ error: false, message: "user ", data: results })
    })
  })
...
app.get(apiversion + "/owners", function (req, res) {
    ...
    db.query("SELECT * FROM users WHERE status_id =3 ", function (error, results, fields) {
      if (error) throw error
      return res.json({ error: false, message: "user ", data: results })
    })
  })
  ...
  app.get(apiversion + "/user/:userId", function (req, res) {
    ...
    db.query("SELECT * FROM users where userId=?", userId.toString(), function (
      error,
      results,
      fields
    ) {
...
app.get(apiversion + "/Confirmhairsalons",verify, function (req, res) {
  ...
  db.query("SELECT * FROM hair_salon WHERE status='0' ", function (error, results, fields) {
    if (error) throw error
    return res.json({ error: false, message: "Confirmhairsalon ", data: results })
  })
})
...
app.get(apiversion + "/notifications", function (req, res) {
  ...
  db.query("SELECT * FROM notification INNER JOIN hair_salon ON notification.hsalon_id=hair_salon.hsalon_id INNER JOIN users ON notification.user_id=users.userId", function (error, results, fields) {
    if (error) throw error
...
app.get(apiversion + "/books", function (req, res) {
  ...
  db.query("SELECT * FROM booking INNER JOIN service ON booking.service_id=service.service_id INNER JOIN hair_salon ON booking.hsalon_id=hair_salon.hsalon_id INNER JOIN users ON booking.hairdresser_id=hairdresser.userId  INNER JOIN users ON booking.customer_id=customer.userId", function (error, results, fields) {
    if (error) throw error
